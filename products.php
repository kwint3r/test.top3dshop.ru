...
$query=('SELECT mac_product_to_category.category_id, mac_product.product_id, mac_product.model, mac_product.date_added FROM mac_product INNER JOIN 
mac_product_to_category ON mac_product.product_id=mac_product_to_category.product_id WHERE mac_product_to_category.main_category="1" ORDER BY  date_added 
DESC');
...
echo $category . " | " . $product_model . " | " . $href . " | " .$date_added ."<br/>";
}
?>