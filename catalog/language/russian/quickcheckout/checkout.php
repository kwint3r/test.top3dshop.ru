...
$_['text_checkout_account']          = 'Адрес получателя';
...
$_['text_shipping_method']           = 'Пожалуйста, выберите предпочтительный способ доставки на этот заказ.';
$_['text_payment_method']            = 'Пожалуйста, выберите предпочтительный способ оплаты на этот заказ.';
...
$_['text_survey']					 = 'How did you hear of us?';
...
$_['entry_address_1']                = 'Адрес доставки:';
...
$_['entry_reward']          		 = 'Enter reward points to use (Max %s):';
