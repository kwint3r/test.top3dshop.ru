...
$_['text_checkout_account']          = 'Шаг 2: Регистрация';
...
$_['text_checkout']                  = 'Способ покупки:';
$_['text_i_am_returning_customer']   = 'Войти в систему';
...
$_['text_recurring_item']            = 'Периодическое товар';
$_['text_payment_profile']           = 'Профиль оплаты';
$_['text_trial_description']         = '%s каждый %d %s(ы) для %d оплат(ы) тогда';
$_['text_payment_description']       = '%s каждый %d %s(ы) для %d оплат(ы)';
$_['text_payment_until_canceled_description'] = '%s каждый %d %s(ы) до отмены';
$_['text_day']                       = 'день';
$_['text_week']                      = 'неделя';
...
$_['entry_fax']                      = 'Факс:';
$_['entry_account']           	     = 'Группа покупателей:';
...
$_['error_vat']                      = 'Неправильный номер ИНН!';
...
$_['text_trial']                    = '%s каждый %s %s для %s платежей тогда ';
