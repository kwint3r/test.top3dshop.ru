...
class ControllerCommonSeoPro extends Controller {
	...
	private function validate($link) {
		$get = array('path', 'ncat', 'blog_id', 'product_id', 'manufacturer_id', 'category_id', 'information_id', 'order_id', 'news_id', 'id', 'album_id', 'record_id', 'filter_tag', 'filter_name');
