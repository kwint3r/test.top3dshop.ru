 ...
 */
//Версия модуля
define ('YANDEX_YML_VERSION', '1.6.6.2');
...
//				$data['cbid'] = 15;
				...
				$data['model'] = $this->config->get($this->CONFIG_PREFIX.'model_field') ? $product[$this->config->get($this->CONFIG_PREFIX.'model_field')] : $product['model'];
				...
				$data['typePrefix'] = $this->config->get($this->CONFIG_PREFIX.'typeprefix_field') ? $product[$this->config->get($this->CONFIG_PREFIX.'typeprefix_field')] : '';
