	...
	public function index() { 
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			/* ADD OCDESIGN.RU Вывод данных information в категории товаров */
				...
				foreach ($product_categorys as $product_category) {
					...
					$information_data = array(
							'link_id'	  => $category_info['information_id'],
							'link'		  => $this->url->link('information/information', 'information_id=' .  $category_info['information_id'])
						);
			...
			/* END */			
				...
				/* ADD OCDESIGN.RU Вывод данных information в категории товаров */
					'lizing'	  => ($category_info) ? $information_data : false
				/* END */
				);
			}
