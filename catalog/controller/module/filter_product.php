			...
			foreach($tabs as $tab) {
				...
				if($tab['title'] == 'latest' || $tab['title'] == 'special' || $tab['title'] == 'bestsellers' || $tab['title'] == 'category') {
					...
					foreach ($results as $result) {
                        ...
                        $prod_cats = $this->model_catalog_product->getCategories($result['product_id']);
                        ...
                        foreach ($prod_cats as $prod_cat)
                        {
                            ...
                            $category_info = $this->model_catalog_category->getCategory($prod_cat['category_id']);
				...
				if($tab['title'] == 'products') {
					...
					foreach ($select_products as $product_id) {
						...
						if ($product_info) {
                            ...
                            $prod_cats = $this->model_catalog_product->getCategories($product_info['product_id']);
