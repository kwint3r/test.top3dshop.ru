...
function simplecheckout_reload(from) {
    ...
    jQuery.ajax({
        ...
        success: function(data) {
			...
			var kupivkredit = jQuery('input[name="payment_method_current"]').val() == 'kupivkredit';

            if ((from == 'create_order' || simple_fix_onchange_and_click) && can_submit_payment_form() && !payment_form_visible() && !kupivkredit) { //&& simple_asap) {
                payment_form_submit();
            }
        },
