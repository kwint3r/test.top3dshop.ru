...
<div id="tab-articles-<?php echo $cmswidget; ?>" class="tab-content">
			...
			<div id="pagewrap">
				<div class="wrapper grid4">
					...
					<div>
					   ...
					   <?php if (isset ($settings_widget['view_avatar']) && $settings_widget['view_avatar'] ) { ?>
                 ...
                 <div class="clearboth bordernone overflowhidden margintop5 lineheight1"></div>
...
$(document).ready(function(){
	...
	// widget code
	// $('#tabs').append ('<a href="#tab-articles-'+cmswidget+'">'+ heading_title + ' ('+ records +')'+'</a>');
