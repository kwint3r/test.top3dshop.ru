...
<div class="blog-content">
	...
	<div>
		...
		<div class="content-records">
			...
			<div class="blog-new-date">Опубликовано: <?php echo $record['date_available']; ?> | Просмотров: <?php echo $record['viewed']; ?></div>		
...
<div data-url="<?php echo $record['href']; ?>" class="pluso" data-background="#ebebeb" data-options="medium,square,line,horizontal,counter,theme=05" data-services="vkontakte,facebook,twitter,google,moimir,linkedin,yandex,email,odnoklassniki,print"></div>			<div class="overflowhidden width100 lineheight1 bordernone">&nbsp;</div>
