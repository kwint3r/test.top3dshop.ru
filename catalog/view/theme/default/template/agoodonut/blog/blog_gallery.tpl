...
<div id="content">
	...
	<div class="blog-heading_title-n">
	...
	<div class="blog-list" >
		...
		<ul>
			...
			<li>
				...
				<?php  } ?>
				<a href="<?php echo $categories[$i]['href']; ?>"><?php echo $categories[$i]['name']; ?>&nbsp;(<?php echo $categories[$i]['total']; ?>)</a>
			</li>
			<?php } ?>
			<?php } ?>
		</ul>
	...
	<div class="acolumns">
		...
		<div class="content-records">
			<div class="name marginbottom5" style="min-height: 25px; overflow: hidden; position:relative;">
			...
			<div class="blog-date_container1">
				...
				<div class="share blog-share_container1" style="float: none; clear: both;">
