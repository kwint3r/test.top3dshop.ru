...
<div id="content">
	<div  class="record-content">
					...
					<div class="comment">
						<div>
							...
							<a onclick="$('a[href=\'#tab-review\']').trigger('click');">
								<?php echo $tab_comment; ?>:
								<ins style="text-decoration:none;" class="comment_count">
									<?php echo $comment_count; ?><!--<?php echo $text_comments; ?>-->
								</ins>
							</a>
							&nbsp;&nbsp;
		...
		<div class="powered_blog_icon">
			<h3 class="blog-icon">Powered by SEO CMS PRO ver.: <?php echo $blog_version; ?> (opencartadmin.com)</h3>
		</div>
