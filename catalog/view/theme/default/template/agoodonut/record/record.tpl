		...
		<div class="record-info">
			<div class="blog-small-record" style="padding: 20px;">
				<ul>
					...
					<li class="blog-data-record" style="background-image: none">Опубликовано: <?php echo $date_added; ?></li>
					<?php } ?>
...
<li class="blog-viewed-record" style="background-image: none">Просмотров: <?php echo $viewed; ?></li>
<?php } ?>
...
<div style="margin-top:20px;margin-left:30px;" class="pluso" data-background="#ebebeb" data-options="medium,square,line,horizontal,counter,theme=05" data-services="vkontakte,facebook,twitter,google,moimir,linkedin,yandex,email,odnoklassniki,print"></div>			
