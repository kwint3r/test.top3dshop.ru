		...
		<div class="megamenu-pattern">
			<div class="container">
				<ul class="megamenu">
					...
					<? /* <li class="home"><a href="<?php echo $home; ?>"><?php if($ustawienia['home_item'] == 'icon') { ?><i class="icon-home"></i><?php } else { echo '<span><strong>'.$home_text.'</strong></span>'; } ?></a></li> */ ?>
					<?php } ?>
					...
					<?php
						foreach($menu as $row) {
							...
							echo "<a href='".$row['link']."' class='".$class_link."' ".$target."><span><strong>".$row['icon'].$row['name'][$lang_id].$row['description']."</strong></span></a>";
