...
<!-- MAIN CONTENT
	================================================== -->
<div class="main-content <?php if($this->theme_options->get( 'content_layout' ) == 1) { echo 'full-width'; } else { echo 'fixed'; } ?> home">
...
<script>(function() {
  ...
  _fbq.push(['addPixelId', '506029779538593']);
})();
window._fbq = window._fbq || [];
window._fbq.push(['track', 'PixelInitialized', {}]);
</script>
<noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?id=506029779538593&ev=PixelInitialized" /></noscript>