...
<head>
    ...
    <?php $lista_plikow = array(
			...
			'catalog/view/theme/vitalia/js/lightbox/html5lightbox.js',
    ...
    <script type="text/javascript" src="catalog/view/javascript/tooltipster/js/jquery.tooltipster.min.js"></script>

    <?php if ($logged) { ?>
<script type="text/javascript">
    updateUserTime();
    setInterval("updateUserTime()", 30000);
</script>
    <?php } ?>
    <script src='https://www.google.com/recaptcha/api.js?onload=onloadCallback&render=explicit' async defer></script>
    <script type="text/javascript">
        var onloadCallback = function() {
            var widgetId1 = grecaptcha.render('g-recaptcha', {
    ...
    <script src="catalog/view/theme/vitalia/js/uploadify/jquery.uploadify.js" type="text/javascript"></script>
    <link rel="stylesheet" type="text/css" href="catalog/view/theme/vitalia/js/uploadify/uploadify.css">
</head>	
<body>

<!-- SafeOnlineReputationWidget START -->
<script type='text/javascript' src='http://top3dshop.safeonlinereputation.ru/widget/'></script>
<!-- SafeOnlineReputationWidget END -->
...
<script type='text/javascript'>
(function(){ var widget_id = 'O7RI5KIztO';
