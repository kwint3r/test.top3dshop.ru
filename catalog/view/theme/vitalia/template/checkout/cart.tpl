      ...
      <table>
        <thead>
          <tr>
            ...
            <td class="name hidden-xs"><?php echo $column_name; ?></td>
            <td class="model hidden-xs"><?php echo $column_model; ?></td>
            <td class="quantity"><?php echo $column_quantity; ?></td>
            <td class="price hidden-xs"><?php echo $column_price; ?></td>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="name hidden-xs"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
              <?php if (!$product['stock']) { ?>
              <span class="stock">***</span>
              <?php } ?>
              <div>
            ...
            <td class="price hidden-xs"><?php echo $product['price']; ?></td>
            <td class="total"><?php echo $product['total']; ?></td>
          </tr>
          <?php } ?>
          <?php foreach ($vouchers as $vouchers) { ?>
          <tr>
            <td class="image hidden-xs"></td>
            ...
            <td class="price hidden-xs"><?php echo $vouchers['amount']; ?></td>
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json['shipping_method']) {
				...
				$.magnificPopup.open({
				  items: {
				    src: '<div class="clearfix">' + html + '</div>', 
				    type: 'inline'
				  },
