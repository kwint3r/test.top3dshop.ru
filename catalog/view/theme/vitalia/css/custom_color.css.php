...
<?php if(!isset($_GET['color_status'])) { ?>
	...
	ul.megamenu > li:hover > a {
		/* background: #<?php echo $_GET['menu_hover_background_gradient_bottom']; ?>; 
		background: -moz-linear-gradient(top, #<?php echo $_GET['menu_hover_background_gradient_bottom']; ?> 0%, #<?php echo $_GET['menu_hover_background_gradient_top']; ?> 0%, #<?php echo $_GET['menu_hover_background_gradient_bottom']; ?> 99%); 
		background: -webkit-gradient(linear, left top, left bottom, color-stop(0%,#<?php echo $_GET['menu_hover_background_gradient_bottom']; ?>), color-stop(0%,#<?php echo $_GET['menu_hover_background_gradient_top']; ?>), color-stop(99%,#<?php echo $_GET['menu_hover_background_gradient_bottom']; ?>)); 
		background: -webkit-linear-gradient(top, #<?php echo $_GET['menu_hover_background_gradient_bottom']; ?> 0%,#<?php echo $_GET['menu_hover_background_gradient_top']; ?> 0%,#<?php echo $_GET['menu_hover_background_gradient_bottom']; ?> 99%); 
		background: -o-linear-gradient(top, #<?php echo $_GET['menu_hover_background_gradient_bottom']; ?> 0%,#<?php echo $_GET['menu_hover_background_gradient_top']; ?> 0%,#<?php echo $_GET['menu_hover_background_gradient_bottom']; ?> 99%); 
		background: -ms-linear-gradient(top, #<?php echo $_GET['menu_hover_background_gradient_bottom']; ?> 0%,#<?php echo $_GET['menu_hover_background_gradient_top']; ?> 0%,#<?php echo $_GET['menu_hover_background_gradient_bottom']; ?> 99%); 
		background: linear-gradient(to bottom, #<?php echo $_GET['menu_hover_background_gradient_bottom']; ?> 0%,#<?php echo $_GET['menu_hover_background_gradient_top']; ?> 0%,#<?php echo $_GET['menu_hover_background_gradient_bottom']; ?> 99%);  */
	}
	<?php } ?>
