  			...
  			<div class="row">
			    ...
			    <div class="col-sm-<?php echo $product_center_grid; ?> product-center clearfix">
			     <div itemprop="offerDetails" itemscope itemtype="http://data-vocabulary.org/Offer">
			      ...
			      <div class="price">
			        <?php if (!$special) { ?>
			        <span class="price-new"><?php echo $text_price; ?> <span itemprop="price"><span id="formated_price" price="<?php echo $price_value; ?>"><?php echo $price; ?></span></span></span>
			        <?php } else { ?>
			        <span class="price-new"><?php echo $text_price; ?> <span itemprop="price"><span id="formated_special" price="<?php echo $special_value; ?>"><?php echo $special; /**/ ?></span></span></span> <span id="formated_price" class="price-old" price="<?php echo $price_value; ?>"><?php echo $price; /**/ ?></span>
			        <?php } ?>
			        <br />
			        <?php if ($tax) { ?>
