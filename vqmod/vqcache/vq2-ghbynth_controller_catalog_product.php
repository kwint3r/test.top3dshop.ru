...
class ControllerCatalogProduct extends Controller {
	...
	public function insert() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			if($this->request->post['usd'] || $this->request->post['eur']){
				$this->load->model('module/currency');
				$this->model_module_currency->index($this->request->get['product_id'], $this->request->post);
			}
	...
	protected function getForm() {
		...
		if(!empty($product_info)) {
			$this->load->model('module/currency');
			$currency_price = $this->model_module_currency->getData($this->request->get['product_id']);
			if($currency_price){
				$this->data['usd'] = $currency_price['usd'];
				$this->data['eur'] = $currency_price['eur'];
			}
		}
		...
		if (isset($this->request->post['record_related'])) {
			...
			$records = $this->model_catalog_product->getRecordRelated($this->request->get['product_id']);
		} else {
			$records = array();
		}
