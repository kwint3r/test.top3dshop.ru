...
class ModelCatalogCategory extends Model {
	...
	/*** EDIT */
		$this->db->query("INSERT INTO " . DB_PREFIX . "category SET `parent_id` = '" . (int)$data['parent_id'] . "', `information_id` = '" . (int)$data['information_id'] . "', `top` = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', `column` = '" . (int)$data['column'] . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', date_modified = NOW(), date_added = NOW(), manufacturers = '".$this->db->escape(serialize($data['manufacturer']))."'");
	/*** EDIT */
	...
	/*** EDIT */
		$this->db->query("UPDATE " . DB_PREFIX . "category SET `parent_id`= '" . (int)$data['parent_id'] . "', `information_id`= '" . (int)$data['information_id'] . "', `top` = '" . (isset($data['top']) ? (int)$data['top'] : 0) . "', `column` = '" . (int)$data['column'] . "', sort_order = '" . (int)$data['sort_order'] . "', status = '" . (int)$data['status'] . "', date_modified = NOW(), manufacturers = '".$this->db->escape(serialize($data['manufacturer']))."' WHERE category_id = '" . (int)$category_id . "'");
	/*** EDIT */
		if (isset($data['image'])) {
			$this->db->query("UPDATE " . DB_PREFIX . "category SET image = '" . $this->db->escape(html_entity_decode($data['image'], ENT_QUOTES, 'UTF-8')) . "' WHERE category_id = '" . (int)$category_id . "'");
		}
