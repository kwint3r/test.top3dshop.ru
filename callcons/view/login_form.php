...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="http://top3dshop.ru/callcons/css/form_style.css" />
    </head>
    <body>
        <div id="content">
            <?php if(!empty($message)) echo "<h3>{$message}</h3><br />"; ?>
            
            <form class="form_style" action="http://top3dshop.ru/callcons/index.php" method="post" id="login_admin">
