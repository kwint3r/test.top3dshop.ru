...
<html>
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="http://top3dshop.ru/callcons/css/admin_style.css" />
        <script type="text/javascript" src="http://top3dshop.ru/callcons/js/settings.js"></script>
        <script type="text/javascript" src="http://top3dshop.ru/callcons/js/jquery.js"></script>
        <script type="text/javascript" src="http://top3dshop.ru/callcons/js/admin_script.js"></script>
        <script type="text/javascript" src="http://top3dshop.ru/callcons/js/colorpicker.js"></script>
        <link rel="stylesheet" media="screen" type="text/css" href="http://top3dshop.ru/callcons/css/colorpicker.css" />
    </head>
    <body>
        <div id="content">
            <div id="content_head">
            ...
            <form action="http://top3dshop.ru/callcons/class/admin_settings.php" method="POST" id="settings_form">
