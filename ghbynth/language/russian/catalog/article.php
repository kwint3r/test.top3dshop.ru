...
$_['entry_parent']         	 = 'Родительская статья:<br/><span class="help">Если статья имеет вложенные статьи, она будет выводиться как категория.</span>';
$_['entry_store']            = 'Магазины:';
$_['entry_keyword']          = 'SEO URL:<br/><span class="help">Должно быть уникальным на всю систему.</span>';
$_['entry_image']            = 'Изображение:<br/><span class="help">Используется в статье, общем списке и как иконка категории.</span>';
