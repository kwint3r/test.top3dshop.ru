<?php
// Heading
$_['heading_title']    					= '<font color="green"><b>JV_QuickOrder - быстрый заказ товара</b></font>';
...
$_['entry_lic_key']   					= 'Ключ активации:<br /><span class="help">От 16 до 80 символов</span>';
...
$_['entry_how_time_show_popup_message'] = 'Сколько времени показывать сообщения об успешном заказе или ошибках, мс';
...
$_['entry_del_system_css_on_show']   	= 'Выключить css-стиль магазина по-умолчанию (stylesheet.css), когда отображается форма быстрого заказа?<br /><br /><span class="help"><font color="green">В абсолютном большинстве случаев эту опцию нужно установить в значение "Отключено".</font><br /><br /><font color="red">И лишь в очень редких случаях, когда отображение формы быстрого заказа, нарушает каким-либо образом отображение встроенных стилей магазина, нужно эту опцию установить в значение "Включено".</font></span>';

//Messages
// Error
$_['error_permission'] 					        = 'У Вас нет прав для изменения модуля!';
$_['error_how_time_show_popup_message'] = 'Время показа сообщений указано неверно!';
