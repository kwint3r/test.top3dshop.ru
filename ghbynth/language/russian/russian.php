...
$_['text_pagination']               = 'Показано с {start} по {end} из {total} ({pages} Страниц)';
...
$_['button_add_geo_zone']           = 'Добавить гео зону';
...
$_['button_update_total']           = 'Обновить итоги';
...
$_['tab_mail']                      = 'Почта';
$_['tab_marketplace_links']         = 'Ссылки Торговых Площадок';
$_['tab_module']                    = 'Модуль';
...
$_['tab_shipping']                  = 'Подробности доставки';
$_['tab_total']                     = 'Итого';
$_['tab_transaction']               = 'Транзакции';
$_['tab_voucher']                   = 'Cертификаты';
$_['tab_voucher_history']           = 'История сертификатов';
$_['tab_price']                     = 'Цена';

// Error
$_['error_upload_1']                = 'Размер загружаемого файла превышает максимальный размер upload_max_filesize директивы, указанный в php.ini!';
$_['error_upload_2']                = 'Размер загружаемого файла превышает значение MAX_FILE_SIZE директивы, которые были указаны в HTML форме!';
