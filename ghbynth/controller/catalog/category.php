...
/* ************************** */
		...
		if (isset($this->request->post['information'])) {
			$this->data['information'] = $this->request->post['information'];
		} elseif (!empty($category_info)) {
		
			$information_info = $this->model_catalog_information->getInformation($category_info['information_id']);
	//echo '<pre>' . print_r($information_info, true) . '</pre>';
...
/* ******************************* */
		...
		if(isset($category_info['manufacturers'])){
