...
/***************************************/
			$payment_download = $this->model_sale_order->getPaymentDownload((int)$this->request->get['order_id']);
			$this->data['payment_download'] = $payment_download['name'];			
			$this->data['payment_href'] = $this->url->link('sale/order/payment_download', 'token=' . $this->session->data['token'] . '&order_id=' . (int)$this->request->get['order_id'], 'SSL');
/***************************************/
...
/*************************************************/
	public function payment_download() {
				...
				$payment_download = $this->model_sale_order->getPaymentDownload($order_id);
				
				if ($payment_download) {
					$file = DIR_DOWNLOAD . $payment_download['filename'];
					$mask = basename($payment_download['name']);
