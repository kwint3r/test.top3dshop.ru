			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
				<table class="form">
					<tr>
						...
						<td><input type="text" name="payonline_merchant" value="<?php echo $payonline_merchant; ?>"/>
					...
					<tr>
						...
						<td><input type="text" name="payonline_security" value="<?php echo $payonline_security; ?>"/>
					...
					<tr>
						...
						<td><select name="payonline_order_status_id">
							<?php foreach ($order_statuses as $order_status) { ?>
							<?php if ($order_status['order_status_id'] == $payonline_order_status_id) { ?>
					...
					<tr>
						...
						<td><select name="payonline_geo_zone_id">
							<option value="0"><?php echo $text_all_zones; ?></option>
							<?php foreach ($geo_zones as $geo_zone) { ?>
							<?php if ($geo_zone['geo_zone_id'] == $payonline_geo_zone_id) { ?>
					...
					<tr>
						...
						<td><select name="payonline_status">
							<?php if ($payonline_status) { ?>
					...
					<tr>
						...
						<td><input type="text" name="payonline_sort_order" value="<?php echo $payonline_sort_order; ?>"
								   size="1"/></td>
					</tr>
				</table>
			</form>
