...
<div style="margin:5px; float:right;">
   <a href="#" class="mbutton blog_save"><?php echo $button_save." (".count($modules).")"; ?></a><a onclick="location = '<?php echo $cancel; ?>';" class="mbutton"><?php echo $button_cancel; ?></a>
</div>
       ...
       <td style="width: 200px;"><?php echo $this->language->get('text_action'); ?></td>
        ...
        ?>
         ...
         <tr class="module-row<?php echo $module_row; ?>" >
   	           ...
   	           <td style="border-top: 1px solid #DDEFD9;"><?php echo $this->language->get('entry_url_schemes'); ?>
                <?php echo $this->language->get('entry_url_template'); ?>
