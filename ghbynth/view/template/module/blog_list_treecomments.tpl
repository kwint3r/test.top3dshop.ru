...
<a onclick="
   ...
   <?php } ?>
	...
	<tr>
			...
			<tr>
				<td>
				<?php echo $this->language->get('entry_admin_name'); ?>

				</td>

				<td>
					<input type="text" name="mylist[<?php echo $list_num; ?>][admin_name]" value="<?php  if (isset( $list['admin_name'])) echo $list['admin_name']; ?>" style="width: 90%;" />
				</td>
			...
			<tr>
			 <td>
				<?php echo $this->language->get('entry_admin_color'); ?>
			 </td>
			 <td>
				<input type="text" name="mylist[<?php echo $list_num; ?>][admin_color]" class="colorpicker"  value="<?php  if (isset( $list['admin_color'])) echo $list['admin_color']; ?>" size="6" />
		...
		<td>
         <select id="mylist_<?php echo $list_num; ?>_order_ad"  name="mylist[<?php echo $list_num; ?>][order_ad]">
          ...
          <tr>
		    ...
		    <tr>
		     <td class="left"><?php echo $this->language->get('entry_handler'); ?></td>
		     <td class="left">
		      <textarea style="width: 96%;" name="mylist[<?php echo $list_num; ?>][handler]"><?php  if (isset($list['handler'])) echo $list['handler']; ?></textarea>
		     </td>
		    </tr>
