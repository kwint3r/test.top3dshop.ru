...
function delayer(){
 ...
 <div id="tabs" class="htabs"><a href="#tab-options"><?php echo $this->language->get('tab_options'); ?></a>
  <a href="#tab-color"><?php echo $this->language->get('tab_color'); ?></a>
 <a href="#tab-install"><?php echo $this->language->get('entry_install_update'); ?></a><a href="#tab-fields"><?php echo $this->language->get('entry_service'); ?></a><a href="#tab-about"><?php echo $this->language->get('entry_about'); ?></a><a href="#tab-faq"><?php echo $this->language->get('entry_faq'); ?></a></div>


<div id="tab-color">
 <div>
 <?php echo $this->language->get('css_help'); ?>
 </div>

   <table class="mynotable" style="margin-bottom:20px; background: white; vertical-align: center;">
    <tr>
     <td class="left"><?php echo $this->language->get('css_user'); ?></td>
     <td class="left">
	<div>
			<textarea name="generallist[css][css]" rows="3" cols="50" ><?php if (isset($generallist['css']['css'])) { echo $generallist['css']['css']; } else { echo ''; } ?></textarea>
	</div>
     </td>
    </tr>
  ...
  <tr>
     <td class="left"><?php echo $this->language->get('css_record-content'); ?></td>
     <td class="left">
	<div>
	<input type="text" name="generallist[css][record-content]" class="colorpicker" size="6" value="<?php if (isset($generallist['css']['record-content'])) echo $generallist['css']['record-content']; ?>" />
	</div>
     </td>
    </tr>

  <tr>
     <td class="left"><?php echo $this->language->get('css_blog-content'); ?></td>
     <td class="left">
	<div>
	<input type="text" name="generallist[css][blog-content]" class="colorpicker" size="6" value="<?php if (isset($generallist['css']['blog-content'])) echo $generallist['css']['blog-content']; ?>" />
	</div>
     </td>
    </tr>
...
<?php echo $this->language->get('text_upgrade_5_6'); ?>
    ...
    <a href="#" onclick="
		$.ajax({
			...
			beforeSend: function()
			{
               $('#create_tables').html('<?php echo $this->language->get('text_loading_main'); ?>');
			},
