...
<form id="form<?php echo $list_num;?>" class="mylist_form">
   ...
   <?php } ?>
	...
	<tr>
			...
			<td>
				...
				<br>
			<a href="" class="hrefajax" id="html_<?php echo $list_num; ?>_<?php echo $language['language_id']; ?>"><?php echo $this->language->get('entry_editor'); ?></a>
...
$('.hrefajax').live('click', function(){
	load_editor($(this).attr('id'), 100);
	return false;
});
