...
<div class="content checkout_loginza_table_content">
			#loginza_label#
		<div align=center class="checkout_loginza_table_links">
...
<div class="content checkout_loginza_button_content">		
				#loginza_label#
			<div  class="checkout_loginza_button_links">
				<a class="<?php echo $classname; ?>"  href="http://loginza.ru/api/widget?token_url=#domain#<?php echo urlencode('/index.php?route=account/loginza2'); 
...
<div class="content checkout_loginza_icons_content">
			
				#loginza_label#
			
		  <div class="checkout_loginza_icons_links">
		  <?php foreach( $res_socnets as $row ) { ?>
		  
			<a class="<?php echo $classname; ?>"  class="loginza" href="https://loginza.ru/api/widget?token_url=#domain#<?php 
			echo urlencode('/index.php?route=account/loginza2'); 
