...
<div id="loginzabox" class="" style="display: block; padding-bottom: 57px; padding: 15px; top: 50px; left: 368px; position: fixed; width: 500px; height: 230px;"
>
...
<a href="#lastlink#"
	style="text-decoration: none; font-size: 20px; position: absolute; top:15px; right: 20px;">X</a>
</div>
