            ...
            <tr>
				...
				<td>
					<div>
						...
						if(isset($manufacturers) && $manufacturers){
							...
							foreach($manufacturers as $manufacturer){
								?>
								<div class="man-field" style="margin-bottom: 5px;">
									<input type="text" name="manufacturer[<?= $i ?>][title]" value="<?= $manufacturer['title'] ?>">
									<input type="text" name="manufacturer[<?= $i ?>][link]" value="<?= $manufacturer['link'] ?>">
							...
							?>
							<div class="man-field" style="margin-bottom: 5px;">
								<input type="text" name="manufacturer[0][title]" placeholder="Название">
								<input type="text" name="manufacturer[0][link]" placeholder="Ссылка">
								<a onclick="$(this).parent().remove();">[ - ]</a>
							</div>
							<?
							$i = 1;
					...
					<script>
						...
						function addManFields(){
							
							$('<div class="man-field" style="margin-bottom: 5px;"><input type="text" class="manufacturer_title" name="manufacturer['+ man_field +'][title]" value="" placeholder="Название"> <input type="text" name="manufacturer['+ man_field +'][link]" value="" placeholder="Ссылка"> <a onclick="$(this).parent().remove();">[ - ]</a></div>').appendTo($('.man-field').parent());
							
							man_field++;
						}
					</script>
					
					<a href="javascript: addManFields();">[ Добавить ]</a>
				</td>
            </tr>
            <tr>
