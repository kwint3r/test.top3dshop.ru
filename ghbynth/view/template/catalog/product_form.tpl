      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              <td>USD</td>
              <td><input type="text" name="usd" value="<?= isset($usd) ? $usd : '' ?>" /></td>
            </tr>
            <tr>
              <td>EUR</td>
              <td><input type="text" name="eur" value="<?= isset($eur) ? $eur : '' ?>" /></td>
            </tr>
            <tr>
        ...
        <div id="tab-links">
          <table class="form">
			...
			<tr>
              <td>Рекомендуемые записи:</td>
              <td>
              <input type="text" name="related_record" id="record_related" class="related_record" value="" />
