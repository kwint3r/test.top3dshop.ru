          ...
          <div id="language<?php echo $language['language_id']; ?>">
            <table class="form">
              ...
              <tr>
                ...
                <td><input type="text" class="category_name" name="blog_description[<?php echo $language['language_id']; ?>][name]" size="100" value="<?php echo isset($blog_description[$language['language_id']]['name']) ? $blog_description[$language['language_id']]['name'] : ''; ?>" />
        ...
        <div id="tab-data">
          <table class="form">
            ...
            <tr>
              ...
              <td><input type="text" id="category_seo_url" name="keyword" value="<?php echo $keyword; ?>" /></td>
            </tr>
            <tr>
...
$(document).ready(function(){
	if ($('#category_seo_url').val()=='') {
			$(".category_name").syncTranslit({destination: "category_seo_url"});
		}
});
</script>
