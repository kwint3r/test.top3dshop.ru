          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($article['selected']) { ?>
                ...
                <?php } ?></td>
              <?php if ($article['href']) { ?>
                <td class="left"><?php echo $article['indent']; ?><a href="<?php echo $article['href']; ?>"><?php echo $article['name']; ?></a></td>
              <?php } else { ?>
                <td class="left"><?php echo $article['indent']; ?><?php echo $article['name']; ?></td>
              <?php } ?>
